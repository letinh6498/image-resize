...
var resizeImage = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, width, height, imageName, widthInt, heightInt, imagePath, resizedImagePath, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 5, , 6]);
                imagePath = path_1.default.join(IMAGES_DIRECTORY, imageName);
                resizedImagePath = path_1.default.join(RESIZED_IMAGES_DIRECTORY, "".concat(imageName, "_").concat(width, "x").concat(height, ".jpg"));
                ...
                return [3 /*break*/, 4];
            case 2: return [4 /*yield*/, (0, sharp_1.default)(imagePath)
